...
public class AppVersionFilter implements WebFilter {
    ...
    public AppVersionFilter(CorsConfigurationSource corsConfigurationSource,
        ...
        // Este filtro barra pela MÍNIMA, que agora é propriedade própria. Era a
        // mesma da versão publicada, e isso obrigava a bloquear todo mundo a
        // cada release -- não havia como anunciar versão nova sem trancar a
        // anterior.
        //
        // O risco de duas propriedades é anunciar uma mínima e barrar por
        // outra. Ele fica coberto no boot do `AppVersionService`, que recusa
        // mínima MAIOR que a publicada -- a única divergência que machuca.
        //
        // Ilegível derruba o boot: um APP_MIN_VERSION torto que virasse
